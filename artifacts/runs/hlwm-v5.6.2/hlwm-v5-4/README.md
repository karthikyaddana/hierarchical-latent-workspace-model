# HLWM Version 5.6.2 - the reduction study

Version 5.6.2 changes exactly four things against the frozen v5.6 configuration: `--num-experts 2` (reduction ladder invoked after Study 6), a validity-gated head phase (>=16 grader-verified valid positives per anchor family, 512-attempt cap, shortfall reported), a report-only generation canary at every evaluation boundary, and a commitment-threshold non-degeneracy diagnostic. Nonzero expert init (0.01) is kept from v5.6.1. Data, budgets, steps, and gate thresholds are unchanged. Plan: `reports/hlwm-v5.6.2-plan-2026-08-31.md`.
